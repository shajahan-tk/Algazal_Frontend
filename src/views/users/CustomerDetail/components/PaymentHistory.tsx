...
const samplePaymentHistory: OrderHistory[] = [
    {
        id: '#36223',
    ...
    },
    {
        ...
        status: 'paid',
        amount: 499.99,
        date: dayjs().subtract(2, 'month').unix()
    },
    {
        id: '#32234',
        item: 'Consulting',
        status: 'pending',
        amount: 199.99,
        date: dayjs().subtract(1, 'week').unix()
    }
]
...
const PaymentHistory = () => {
    const [data] = useState<OrderHistory[]>(samplePaymentHistory)
